        ...
        <main>
            <div class="menu">
                ...
                <div class="menu-item" style="text-align: center;">
                    ...
                    <a https://github.com/Omar-Garcia-Renteria/Proyecto-SANE/resources/views/contacto/index.blade.php">GENERAR ARCHIVO SANE</a>
                    </div>

                    <div class="menu-item" style="text-align: center;">
                    <img src="/images/Designer (2).jpeg" alt="Incentivo" style="width:100px; height:125px">
                    <a https://github.com/Omar-Garcia-Renteria/Proyecto-SANE/SANE2.0/resources/views/contacto/excel/index.blade.php">INCENTIVO 1</a> <br>
                </div> <br> <br>
